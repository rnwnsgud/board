...
public class Forum {
    ...
    public Forum managerModify(ForumUpdate forumUpdate, ClockLocalHolder clockLocalHolder) {
        return Forum.builder()
                .forumId(forumId)
                .name(name)
                .introduction(forumUpdate.getIntroduction() != null ? forumUpdate.getIntroduction() : introduction)
                .category(forumUpdate.getCategory() != null ? forumUpdate.getCategory() : category)
                .forumStatus(forumStatus)
                .createdAt(createdAt)
